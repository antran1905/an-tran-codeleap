...
export function DogCardStackSkeleton() {
  return (
    <div
      ...
      className="relative h-full max-h-[calc(100svh-10.5rem)] min-h-[20rem] w-full touch-none overflow-hidden sm:mx-auto sm:h-[74svh] sm:max-h-136 sm:min-h-80 sm:max-w-md"
      role="status"
    >
      <div
        aria-hidden
